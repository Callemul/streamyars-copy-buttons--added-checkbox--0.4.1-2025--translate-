...
window.SYH_STATS_EXPORTER = {
    ...
    showModal: function(currentBrand) {
    ...
    loadChartData: function(currentBrand) {
        ...
        if (storage) {
            storage.get(['syh_stream_charts'], function(result) {
                ...
                document.getElementById('syh-dl-csv-btn').onclick = () => self.exportCSV(brandData[today], today, currentBrand);
                document.getElementById('syh-dl-pres-btn').onclick = () => self.exportPresentation(brandData[today], today, currentBrand);
            });
        }
    },
    ...
    exportCSV: function(dataObj, dateStr, currentBrand) {
    ...
    exportPresentation: function(dataObj, dateStr, currentBrand) {
