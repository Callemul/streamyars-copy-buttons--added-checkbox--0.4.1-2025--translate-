 ...
 *
 * УВАГА: переданий `buttonStates` мутається НА МІСЦІ (`delete`/`=`), це
 * навмисний side-effect (in-place ради продуктивності). Викликач має бути
 * готовим до того, що його об'єкт кешу зміниться, і отримує той самий
 * (оновлений) об'єкт як результат.
 */
