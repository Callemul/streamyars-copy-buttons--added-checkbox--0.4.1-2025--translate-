...
> **Статус:** ✅ ВИПРАВЛЕНО (2026-08-10). `try/catch` навколо `createSingleBanner("----Питання глядачів----")` + `.catch` у викликача — збій розділювача більше не обриває `finalCleanup`. Регрес-тест `tests/banner_form.test.js` (21).
---
