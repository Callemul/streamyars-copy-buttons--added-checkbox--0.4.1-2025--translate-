...
> **Статус:** ✅ ВИПРАВЛЕНО (2026-08-10). `flashCopyIcon` показує ✅ лише при `success`; інакше — попереджувальний тост. Регрес-тест `tests/ui_comments_copy_filter.test.js` (5b, 11).
---
