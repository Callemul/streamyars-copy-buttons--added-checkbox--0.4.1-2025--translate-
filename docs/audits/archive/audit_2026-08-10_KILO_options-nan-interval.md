...
> **Статус:** ✅ ВИПРАВЛЕНО (2026-08-10). `readInteger` повертає `0` замість `NaN`; запис у storage та «зациклення» поля на `"NaN"` усунуто. Регрес-тест `tests/options_settings.test.js` (5).
---
