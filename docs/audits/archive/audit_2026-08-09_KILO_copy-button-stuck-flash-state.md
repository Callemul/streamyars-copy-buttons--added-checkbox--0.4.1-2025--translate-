...
> **Статус:** ✅ ВИПРАВЛЕНО (2026-08-10). `handleCopyClick` захоплює оригінальний HTML/title лише один раз на цикл спокою і скасовує попередній таймер спалаху; `flashCopyIcon` теж скасовує попередній таймер. Подвійний швидкий клік більше не лишає кнопку на ✓/❌. Додано регрес-тести №38, №39 у `tests/comment_injector.test.js`.
