...
>
> **Статус:** ⛔ НЕ ВИПРАВЛЕНО. Рефакторинг зберігає поведінку 1-в-1. Виправлення потребує
> окремого погодження (змінює UX — з'являється новий видимий відгук про помилку).
---
